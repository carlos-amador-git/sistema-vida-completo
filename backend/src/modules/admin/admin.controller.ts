...
router.get('/metrics/emergency',
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Error getting emergency metrics:', error);
      res.status(500).json({
        success: false,
...
router.get('/metrics/directives',
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Error getting directive metrics:', error);
      res.status(500).json({
        success: false,
...
router.get('/audit/admin',
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Error listing admin audit logs:', error);
      res.status(500).json({
        success: false,
...
router.get('/audit/emergency',
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Error listing emergency accesses:', error);
      res.status(500).json({
        success: false,
...
router.get('/audit/panic-alerts',
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Error listing panic alerts:', error);
      res.status(500).json({
        success: false,
...
router.get('/institutions/:id',
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Error getting institution detail:', error);
      res.status(error.status || 500).json({
        success: false,
...
router.get('/insurance',
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Error listing insurance:', error);
      res.status(500).json({
        success: false,
...
router.get('/insurance/:id',
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Error getting insurance detail:', error);
      res.status(error.status || 500).json({
        success: false,
...
router.post('/insurance/:id/network/:hospitalId',
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Error adding hospital to network:', error);
      res.status(error.status || 500).json({
        success: false,
...
router.delete('/insurance/:id/network/:hospitalId',
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.error('Error removing hospital from network:', error);
      res.status(error.status || 500).json({
        success: false,
